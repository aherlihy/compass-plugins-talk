...
const debug = require('debug')('mongodb-compass:stores:whoami');

/**
 * Whoami store.
 */
const WhoamiStore = Reflux.createStore({
  /**
  ...
  /**
   * Initialize the Whoami store state. The returned object must
  ...
  storeDidUpdate(prevState) {
    debug('Whoami store changed from', prevState, 'to', this.state);
  }
});
